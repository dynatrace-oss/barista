...
@Component({
  selector: 'dt-example-table-export-selectable-column',
  templateUrl: './table-export-selection-example.html',
  styleUrls: ['./table-export-selection-example.scss'],
  providers: [
    {
...
export class DtExampleTableExportSelection implements AfterViewInit {
  data: Row[] = [
    {
      host: 'et-demo-2-win4',
      cpu: 30,
  ...
  ngAfterViewInit(): void {
    ...
    // Set the dtTableSelection on the dataSource, for exporting.
    setTimeout(() => {
      //async to avoid https://angular.io/errors/NG0100
