...
import { TO_REPLACE_TEMPLATE_ARIA_ATTRIBUTES } from './replacers';

/**
 * Removes deprecated aria-label properties from template (html) files and
 * updates attributes correspondingly (see ./replacers).
 */
export function removeAriaLabelRule(): Rule {
  return (tree: Tree, _: SchematicContext) => {
    ...
    for (const file of htmlFiles) {
      ...
      TO_REPLACE_TEMPLATE_ARIA_ATTRIBUTES.forEach((toReplace) => {
