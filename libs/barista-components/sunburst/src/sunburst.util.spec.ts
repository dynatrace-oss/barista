      ...
      const expected = [
        {
          children: [
            {
              color: palette[1],
              origin: sunburstMock[0].children[1],
              depth: 1,
              id: '0.0',
              label: 'Blue',
              value: 1,
            ...
            {
              color: palette[1],
              origin: sunburstMock[0].children[0],
              depth: 1,
              id: '0.1',
              label: 'Red',
              value: 3,
        ...
        },
        {
          children: [
            {
              color: palette[0],
              origin: sunburstMock[1].children[1],
              depth: 1,
              id: '1.0',
              label: 'Blue',
              value: 1,
            ...
            {
              color: palette[0],
              origin: sunburstMock[1].children[0],
              depth: 1,
              id: '1.1',
              label: 'Yellow',
              value: 3,
