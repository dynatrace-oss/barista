...
export class DtChartSelectionAreaOverlayRef implements OnDestroy {
  /** Subject that emits and completes when the overlay ref is destroyed */
  ...
  /** Observable that emits when the overlay starts with the leave animating */
  closing(): Observable<void> {
    return this.containerRef._onLeaving;
  }
