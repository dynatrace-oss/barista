...
import { DtSort, DtTableDataSource, formatPercent, formatBytes, formatRate, DtIndicatorThemePalette } from '@dynatrace/angular-components';
...
export class TableSimpleColumnsComponent implements AfterViewInit {
  data: object[] = [
