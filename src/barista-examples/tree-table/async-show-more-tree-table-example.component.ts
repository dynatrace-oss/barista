...
@Component({
  ...
  <dt-tree-table [dataSource]="dataSource" [treeControl]="treeControl">
    ...
    <ng-container dtColumnDef="blocked" dtColumnAlign="right">
      ...
      <dt-cell *dtCellDef="let row"><ng-container *ngIf="!row.isShowMore">{{row.blocked}}ms</ng-container></dt-cell>
    </ng-container>
    ...
    <ng-container dtColumnDef="running" dtColumnAlign="center">
      ...
      <dt-cell *dtCellDef="let row"><ng-container *ngIf="!row.isShowMore">{{row.running}}ms</ng-container></dt-cell>
    </ng-container>

    <ng-container dtColumnDef="waiting">
      <dt-tree-table-header-cell *dtHeaderCellDef>Waiting</dt-tree-table-header-cell>
      <dt-cell *dtCellDef="let row"><ng-container *ngIf="!row.isShowMore">{{row.waiting}}ms</ng-container></dt-cell>
    </ng-container>

    <ng-container dtColumnDef="showMore">
      <dt-tree-table-toggle-cell *dtCellDef="let row">
        <button dt-button variant="secondary" (click)="showMore()">Show more</button>
      </dt-tree-table-toggle-cell>
    </ng-container>
...
export class AsyncShowMoreTreeTable {
