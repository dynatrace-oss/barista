...
import { DtTabGroupNavigationControl, DtTabNavigationAdapter } from './tab-navigation-adapter';
...
export class DtTabGroupNavigation implements DtTabGroupNavigationControl, OnDestroy, AfterContentInit {
  ...
  private _getTabs(): DtTab[] { return this._tabGroup ? this._tabGroup._tabs.toArray() : []; }
}
