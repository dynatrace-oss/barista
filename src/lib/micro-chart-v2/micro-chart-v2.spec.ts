...
import { DtMicroChartV2 } from './micro-chart';
...
describe('DtMicroChart', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [DtMicroChartV2Module, DtThemingModule, DtChartModule],
      declarations: [
        Series,
        DefinedAxis,
        DefinedAxisArray,
  ...
  const setupTestCase = <T>(componentType: Type<T>):
    { fixture: ComponentFixture<T>; microChartComponent: DtMicroChartV2 } => {
    const fixture = TestBed.createComponent(componentType);
    const microChartDebugElement = fixture.debugElement.query(By.directive(DtMicroChartV2));
    const microChartComponent = microChartDebugElement.componentInstance as DtMicroChartV2;
