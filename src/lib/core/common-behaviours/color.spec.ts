...
describe('MixinColor', () => {
  ...
  it('should remove old color classes if new color is set', () => {
    ...
    expect(instance.testElement.classList)
      .toContain('dt-color-accent', 'Expected the element to have the "dt-color-accent" class set');
  });
  ...
  it('should allow having a default color if specified', () => {
    ...
    expect(instance.testElement.classList)
      .toContain('dt-color-accent', 'Expected the element to have the "dt-color-accent" class by default.');

    instance.color = undefined;

    expect(instance.testElement.classList)
      .toContain('dt-color-accent', 'Expected the default color "dt-color-accent" to be set.');
  });
