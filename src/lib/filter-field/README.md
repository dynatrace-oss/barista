...
2. Setting filters that have parts that are not yet loaded and therefore behind an async flag is currently not supported (Watch the following issue to be notified when this is possible: [***REMOVED***](https://dev-jira.dynatrace.org/browse/***REMOVED***)).
...
Note: The following functionalities are not yet implemented. If you are interested in the implementation progress, [reach out to the DesignOps team](https://dynatrace.slack.com/messages/CJUCU3J6T).
