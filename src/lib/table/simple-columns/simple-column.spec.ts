...
describe('DtTable SimpleColumns', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        TestSimpleColumnsApp,
        TestSimpleColumnsErrorApp,
      ],
    });
  ...
  describe('rendering', () => {
    ...
    it('should display the correct simple-text values', () => {
      const cells = fixture.debugElement.queryAll(By.css('.dt-cell.dt-table-column-host'));
      expect(cells[0].nativeElement.textContent).toBe(fixture.componentInstance.data[0].host.toString());
      expect(cells[1].nativeElement.textContent).toBe('');
      expect(cells[2].nativeElement.textContent).toBe(fixture.componentInstance.data[2].host.toString());
      expect(cells[3].nativeElement.textContent).toBe(fixture.componentInstance.data[3].host.toString());
    });

    it('should display the correct simple-number values', () => {
      const cells = fixture.debugElement.queryAll(By.css('.dt-cell.dt-table-column-cpu'));
      expect(cells[0].nativeElement.textContent).toBe(fixture.componentInstance.data[0].cpu.toString());
      expect(cells[1].nativeElement.textContent).toBe(fixture.componentInstance.data[1].cpu.toString());
      expect(cells[2].nativeElement.textContent).toBe('');
      expect(cells[3].nativeElement.textContent).toBe(fixture.componentInstance.data[3].cpu.toString());
    });

    it('should display the correct simple-percentage values', () => {
      const cells = fixture.debugElement.queryAll(By.css('.dt-cell.dt-table-column-memoryPerc'));
      expect(cells[0].nativeElement.textContent).toBe(`${fixture.componentInstance.data[0].memoryPerc} %`);
      expect(cells[1].nativeElement.textContent).toBe(`${fixture.componentInstance.data[1].memoryPerc} %`);
      expect(cells[2].nativeElement.textContent).toBe(`${fixture.componentInstance.data[2].memoryPerc} %`);
      expect(cells[3].nativeElement.textContent).toBe(`${fixture.componentInstance.data[3].memoryPerc} %`);
    });

    it('should display the correct values when accessing through a dataAccessor', () => {
      const cells = fixture.debugElement.queryAll(By.css('.dt-cell.dt-table-column-memoryConsumption'));
      const transformFunction = fixture.componentInstance.combineMemory.bind(this);
      expect(cells[0].nativeElement.textContent).toBe(transformFunction(fixture.componentInstance.data[0]));
      expect(cells[1].nativeElement.textContent).toBe(transformFunction(fixture.componentInstance.data[1]));
      expect(cells[2].nativeElement.textContent).toBe(transformFunction(fixture.componentInstance.data[2]));
      expect(cells[3].nativeElement.textContent).toBe(transformFunction(fixture.componentInstance.data[3]));
    });
  ...
  describe('dynamic data', () => {
    ...
    it('should add a new row at the bottom', () => {
      fixture.componentInstance.dataSource.data = [
        ...
        { host: 'et-demo-2-win3', cpu: 24, memoryPerc: 23, memoryTotal: 5820000000, traffic: 98700000 },
      ];
      fixture.detectChanges();
      ...
      expect(newlyAddedCells[0].nativeElement.textContent).toBe('et-demo-2-win3');
      expect(newlyAddedCells[1].nativeElement.textContent).toBe('24');
      expect(newlyAddedCells[2].nativeElement.textContent).toBe('23 %');
      expect(newlyAddedCells[3].nativeElement.textContent).toBe('23 % of 5.42 GB');
    });
    ...
    it('should add a new row in correct sorted order', () => {
      const sortHeader = fixture.debugElement.query(By.css('.dt-header-cell.dt-table-column-host'));
    ...
    it('should add a new row in correct sorted order', () => {
      const sortHeader = fixture.debugElement.query(By.css('.dt-header-cell.dt-table-column-cpu'));
      dispatchMouseEvent(sortHeader.nativeElement, 'click');
      fixture.componentInstance.dataSource.data = [
        ...fixture.componentInstance.data,
        { host: 'et-demo-2-win3', cpu: 24, memoryPerc: 23, memoryTotal: 5820000000, traffic: 98700000 },
  ...
  describe('sorting', () => {
    ...
    it('should set the headers sortable by default', () => {
      const sortHeaders = fixture.debugElement.queryAll(By.css('.dt-sort-header-container'));
    ...
    it('should apply sort styles to header', () => {
      ...
      const headerCell = fixture.debugElement.queryAll(By.css('.dt-header-cell'))[1];
      expect(headerCell.nativeElement.getAttribute('aria-sort')).toBe('descending');
      const cells = fixture.debugElement.queryAll(By.css('.dt-cell.dt-table-column-cpu'));
      expect(cells[1].nativeElement.classList.contains('dt-cell-sorted')).toBe(true);
    });
    ...
    it('should apply sort styles to cells', () => {
      ...
      for (const cell of cells) {
        expect(cell.nativeElement.classList.contains('dt-cell-sorted')).toBe(true);
      }
    });
    ...
    it('should sort the number column correctly ascending (alternate)', () => {
      ...
      const headerCell = fixture.debugElement.queryAll(By.css('.dt-header-cell'))[1];
      expect(headerCell.nativeElement.getAttribute('aria-sort')).toBe('ascending');
    ...
    it('should sort the text column correctly ascending (start)', () => {
      ...
      const headerCell = fixture.debugElement.queryAll(By.css('.dt-header-cell'))[0];
      expect(headerCell.nativeElement.getAttribute('aria-sort')).toBe('ascending');
  ...
  describe('indicator', () => {
    it('should have the correct indicator classes on the affected rows', fakeAsync(() => {
      ...
      expect(rows[0].nativeElement.classList).toContain('dt-table-row-indicator');
      expect(rows[0].nativeElement.classList).toContain('dt-color-error');
      expect(rows[1].nativeElement.classList).toContain('dt-table-row-indicator');
      expect(rows[1].nativeElement.classList).toContain('dt-color-warning');
      expect(rows[3].nativeElement.classList).toContain('dt-table-row-indicator');
...
@Component({
  ...
  template: `<dt-table [dataSource]="dataSource" dtSort #sortable>
    ...
    <dt-simple-number-column name="memoryConsumption" label="Memory combined" [displayAccessor]="combineMemory"></dt-simple-number-column>
    <dt-simple-number-column name="traffic" label="Traffic" [sortable]="isSortable" [formatter]="trafficFormatter" [hasProblem]="trafficHasProblem"></dt-simple-number-column>
...
class TestSimpleColumnsApp implements AfterViewInit {
  data: Array<{host: string|undefined; cpu: number|undefined; memoryPerc: number; memoryTotal: number; traffic: number }> = [
    { host: 'et-demo-2-win4', cpu: 30, memoryPerc: 38, memoryTotal: 5830000000, traffic: 98700000 },
    { host: undefined, cpu: 26, memoryPerc: 46, memoryTotal: 6000000000, traffic: 62500000 },
    { host: 'docker-host2', cpu: undefined, memoryPerc: 35, memoryTotal: 5810000000, traffic: 41900000 },
  ...
  trafficFormatter = (value) => formatBytes(formatRate(value, 's'), { inputUnit: 'byte', outputUnit: 'MB', factor: 1024 });
...
@Component({
  ...
  template: `<dt-table [dataSource]="dataSource">
    ...
    <dt-simple-number-column name="memoryPerc" label="Memory" [formatter]="percentageFormatter"></dt-simple-number-column>
    <dt-simple-number-column name="memoryConsumption" label="Memory combined" [displayAccessor]="combineMemory"></dt-simple-number-column>
    <dt-simple-number-column name="traffic" label="Traffic" [sortable]="isSortable" ></dt-simple-number-column>
