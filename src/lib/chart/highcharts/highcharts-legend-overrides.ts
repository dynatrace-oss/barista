...
export const configureLegendSymbols = ((): void => {
  ...
  // tslint:disable-next-line: no-any
  highcharts.seriesTypes.area.prototype.drawLegendSymbol = function(_legend: any, item: any): void {
  ...
  // tslint:disable-next-line: no-any
  highcharts.seriesTypes.line.prototype.drawLegendSymbol = function(_legend: any, item: any): void {
    item.legendSymbol = this.chart.renderer.path(
  ...
  // tslint:disable-next-line: no-any
  highcharts.seriesTypes.column.prototype.drawLegendSymbol = function(_legend: any, item: any): void {
    item.legendSymbol = this.chart.renderer.path(
