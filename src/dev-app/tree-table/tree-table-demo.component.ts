...
export class TreeTableDemo {
  ...
  transformer = (node: ThreadNode, level: number) => {
  ...
  addChild(parent: ThreadFlatNode): void {
    const parentNode = this.flatNodeMap.get(parent);
    
    parentNode!.children!.push({
      name: `Downtime timer-1000`,
      icon: 'apache-tomcat',
      threadlevel: 'S1',
      totalTimeConsumption: 150,
      waiting: 123,
    ...
    // this.treeControl.expand(this.treeControl.dataNodes[7]);
  }
}