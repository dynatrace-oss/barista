...
const series = generateData(40, 1000, 2000, 1370304000000, 900000);
...
export class MicroChartDemo {
  get series(): DtChartSeries {
    return {
      name: 'Requests',
      data: lodashMerge([], series),
    };
  }

  get seriesWithGaps(): DtChartSeries {
    return {
      name: 'Requests with Gaps',
      data: lodashMerge([], seriesWithGaps),
    };
  }
}
