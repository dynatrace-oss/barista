...
<br>
<div [dtExpandablePanel]="panel1" #trigger1="dtExpandablePanelTrigger">Toggle trigger (<span *ngIf="trigger1.opened">Close</span><span *ngIf="!trigger1.opened">Open</span>) </div>`,
