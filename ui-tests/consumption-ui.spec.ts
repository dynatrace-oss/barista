...
describe('Consumption', () => {
  describe('check overlay behavior', () => {
    ...
    it('should show an overlay containing custom content while hovering and hide it when the mouse leaves the element', async () => {
