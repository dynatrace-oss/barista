...
| `dt-consumption-icon-alt-text`          | A `dt-breadcrumbs` must always have an alternative text in form of an `aria-label` or an `aria-labelledby` attribute.                                                                                                                               |
...
| `dt-icon-button-alt-text`               | A `dt-breadcrumbs` must always have an alternative text in form of an `aria-label` or an `aria-labelledby` attribute.                                                                                                                               |
...
| `dt-menu-alt-text`                      | A `dt-breadcrumbs` must always have an alternative text in form of an `aria-label` or an `aria-labelledby` attribute.                                                                                                                               |
...
| `dt-table-search-alt-text`              | A `dt-breadcrumbs` must always have an alternative text in form of an `aria-label` or an `aria-labelledby` attribute.                                                                                                                               |
